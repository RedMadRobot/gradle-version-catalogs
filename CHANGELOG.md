...
- :arrow_up: [firebase-bom](https://firebase.google.com/support/release-notes/android#bom_v33-7-0) `33.2.0` → `33.7.0`
  ...
  - :arrow_up: [firebase-config](https://firebase.google.com/support/release-notes/android#remote-config_v22-0-1) `22.0.0` → `22.0.1`
...
- :arrow_up: [work](https://developer.android.com/jetpack/androidx/releases/work#2.9.1) `2.9.0` → `2.9.1`
...
- :arrow_up: [detekt-rules-compose](https://github.com/appKODE/detekt-rules-compose/releases/tag/v1.4.0) `1.3.0` → `1.4.0` :warning:
...
- :arrow_up: [kotlin](https://github.com/JetBrains/kotlin/releases/tag/v2.0.20) `2.0.0` → `2.0.20`
- :arrow_up: [kotlinx-coroutines](https://github.com/Kotlin/kotlinx.coroutines/releases/tag/1.9.0-RC.2) `1.9.0-RC` → `1.9.0-RC.2`
- :arrow_up: [kotlinx-serialization](https://github.com/Kotlin/kotlinx.serialization/releases/tag/v1.7.2) `1.7.1` → `1.7.2`
