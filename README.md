...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("rmr") {
            from("com.redmadrobot.versions:versions-redmadrobot:2022.07.03")
        }
        create("androidx") {
            from("com.redmadrobot.versions:versions-androidx:2022.07.03")
        }
        create("stack") {
            from("com.redmadrobot.versions:versions-stack:2022.07.03")
        }
    }
}
```
